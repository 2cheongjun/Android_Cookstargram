...
public class ViewUpdateActivity extends AppCompatActivity {
    ...
    private ViewDataModel datalist = null;
...
//        // TODO : Cookadapter에서 받아온 인텐트
        if (getIntent() != null) {
            ...
            datalist = (ViewDataModel)getIntent().getSerializableExtra("data");
        }
        ...
        // 진행률 다이얼로그
        progressDialog = new ProgressDialog(ViewUpdateActivity.this);
        ...
        tv_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RequestQueue queue = Volley.newRequestQueue(ViewUpdateActivity.this);
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                Toast.makeText(ViewUpdateActivity.this, "success" + message, Toast.LENGTH_SHORT).show();
//
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(ViewUpdateActivity.this, "Image Upload Failed", Toast.LENGTH_SHORT).show();
        ...
        // 이미지 업로드 볼리
        requestQueue = Volley.newRequestQueue(ViewUpdateActivity.this);
    ...
    public boolean CheckPermission() {
        if (ContextCompat.checkSelfPermission(ViewUpdateActivity.this,
                Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(ViewUpdateActivity.this,
                Manifest.permission.CAMERA)
                != PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(ViewUpdateActivity.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(ViewUpdateActivity.this,
                    Manifest.permission.READ_EXTERNAL_STORAGE) || ActivityCompat.shouldShowRequestPermissionRationale(ViewUpdateActivity.this,
                    Manifest.permission.CAMERA) || ActivityCompat.shouldShowRequestPermissionRationale(ViewUpdateActivity.this,
                    Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                new AlertDialog.Builder(ViewUpdateActivity.this)
                        .setTitle("Permission")
                        ...
                        .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(ViewUpdateActivity.this,
                                        new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                        MY_PERMISSIONS_REQUEST_LOCATION);


                                startActivity(new Intent(ViewUpdateActivity.this, WriteActivity.class));
                                ViewUpdateActivity.this.overridePendingTransition(0, 0);
                            }
                        })
                        .create()
                        .show();
