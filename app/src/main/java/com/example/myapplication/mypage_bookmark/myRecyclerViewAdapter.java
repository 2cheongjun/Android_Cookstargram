...
public class myRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final ArrayList<DataModel> mDatalist; // 북마크 각아이템 데이터
    ...
    public myRecyclerViewAdapter(Context context, ArrayList<DataModel> datalist) {
        mDatalist = datalist;
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.bookmark_grid_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        // 데이터 연결부분
        DataModel datalist = mDatalist.get(position);

        Log.e("북마크 데이터 가져오기", String.valueOf(datalist));
            ...
            mPostImg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(onBookItemClickListener !=null){
                        ...
                        onBookItemClickListener.onBookItemClickListener(position,postIdx);
                    }
                }
            });
        }
